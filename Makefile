...
OBJECTS += smallAES/small_aes.o

 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/analogin_api.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/cmsis_nvic.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/gpio_api.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/gpio_irq_api.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/i2c_api.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/mbed_board.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/mbed_retarget.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/mbed_sdk_boot.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/pinmap.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/port_api.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/pwmout_api.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/serial_api.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/sleep.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/spi_api.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/startup_NRF51822.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/system_nrf51.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/twi_master.o
 SYS_OBJECTS += mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/us_ticker.o
...
INCLUDE_PATHS += -I../mbed/TARGET_NRF51_MICROBIT
INCLUDE_PATHS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC
INCLUDE_PATHS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822
INCLUDE_PATHS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib
INCLUDE_PATHS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/nordic_sdk
INCLUDE_PATHS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/nordic_sdk/components
INCLUDE_PATHS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/nordic_sdk/components/libraries
INCLUDE_PATHS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/nordic_sdk/components/libraries/crc16
INCLUDE_PATHS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/nordic_sdk/components/libraries/scheduler
INCLUDE_PATHS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/nordic_sdk/components/libraries/util
INCLUDE_PATHS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/TARGET_NRF51_MICROBIT
INCLUDE_PATHS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/device
...
INCLUDE_PATHS += -I../smallAES

LIBRARY_PATHS := -L../mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM 
LIBRARIES := -lmbed 
LINKER_SCRIPT ?= ../mbed/TARGET_NRF51_MICROBIT/TOOLCHAIN_GCC_ARM/NRF51822.ld
...
PREPROC = arm-none-eabi-cpp -E -P -Wl,--gc-sections -Wl,--wrap,main -Wl,--wrap,_malloc_r -Wl,--wrap,_free_r -Wl,--wrap,_realloc_r -Wl,--wrap,_memalign_r -Wl,--wrap,_calloc_r -Wl,--wrap,exit -Wl,--wrap,atexit -Wl,-n --specs=nano.specs -mcpu=cortex-m0 -mthumb -DMBED_BOOT_STACK_SIZE=4096 -DXIP_ENABLE=0
...
C_FLAGS += -DTARGET_NRF51_MICROBIT
C_FLAGS += -D__MBED__=1
C_FLAGS += -DTARGET_MCU_NRF51_16K_S110
C_FLAGS += -DTARGET_NAME=NRF51_MICROBIT
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1591714992.9268491
...
CXX_FLAGS += -DTARGET_NRF51_MICROBIT
CXX_FLAGS += -D__MBED__=1
CXX_FLAGS += -DTARGET_MCU_NRF51_16K_S110
CXX_FLAGS += -DTARGET_NAME=NRF51_MICROBIT
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1591714992.9268491
...
ASM_FLAGS += -I../mbed
ASM_FLAGS += -I../mbed/TARGET_NRF51_MICROBIT
ASM_FLAGS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC
ASM_FLAGS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822
ASM_FLAGS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib
ASM_FLAGS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/nordic_sdk
ASM_FLAGS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/nordic_sdk/components
ASM_FLAGS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/nordic_sdk/components/libraries
ASM_FLAGS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/nordic_sdk/components/libraries/crc16
ASM_FLAGS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/nordic_sdk/components/libraries/scheduler
ASM_FLAGS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/nordic_sdk/components/libraries/util
ASM_FLAGS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/TARGET_NRF51_MICROBIT
ASM_FLAGS += -I../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/device
...
ASM_FLAGS += -I../smallAES
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/b/b06917599c73a2d5556ed7b7a4ee1681/BLE_BBC_MMA8653_MAG/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
...
LD_FLAGS :=-Wl,--gc-sections -Wl,--wrap,main -Wl,--wrap,_malloc_r -Wl,--wrap,_free_r -Wl,--wrap,_realloc_r -Wl,--wrap,_memalign_r -Wl,--wrap,_calloc_r -Wl,--wrap,exit -Wl,--wrap,atexit -Wl,-n --specs=nano.specs -mcpu=cortex-m0 -mthumb -DMBED_BOOT_STACK_SIZE=4096 -DXIP_ENABLE=0 
...
$(PROJECT)-combined.hex: $(PROJECT).hex
	...
	$(SREC_CAT) ../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/s110_nrf51822_8_0_0/s110_nrf51822_8.0.0_softdevice.hex ../mbed/TARGET_NRF51_MICROBIT/TARGET_NORDIC/TARGET_MCU_NRF51822/Lib/s130_nrf51822_1_0_0/s130_nrf51_1.0.0_softdevice.hex ../nRF51822/TARGET_MCU_NRF51822/bootloader/s110_nrf51822_8.0.0_bootloader.hex ../nRF51822/TARGET_MCU_NRF51822/bootloader/s130_nrf51_1.0.0_bootloader.hex  -intel $(PROJECT).hex -intel -o $(PROJECT)-combined.hex -intel --line-length=44
